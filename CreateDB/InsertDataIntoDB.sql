...
('2', 'Do my test, dev and production environments need to be similar?', TRUE, 'In order to ensure an app progresses correctly through the development Life Cycle, the different environments need to be similar in order to effectively predict the apps behaviour at every stage.'),
